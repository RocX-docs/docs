...
Eligible activity can create it, users can accumulate or use it, and product policy can connect it back into the ecosystem.
...
Active Energy is a non-transferable offchain participation point, not a token or a guaranteed one-time reward.
...
A portion of Active Energy connected to supported experiences may return to the ecosystem according to operating policy.
...
The principle matters more than a fixed percentage or distribution formula.
