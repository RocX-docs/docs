...
<CardGroup cols={3}>
  <Card title="DeFi 행성" icon="coins" href="./defi-planet-overview">
    예치, 대출, 스왑, 브릿지 및 지원되는 온체인 금융 활동을 위한 **자본 레이어**입니다.
  </Card>
  <Card title="PoA 행성" icon="fingerprint" href="./poa-planet-overview">
    의미 있는 활동을 등록하고 검증하며 평가하는 **참여와 기여 레이어**입니다.
  </Card>
  <Card title="Explore 행성" icon="compass" href="./explore-planet-overview">
...
<CardGroup cols={2}>
  <Card title="크로스플랫폼 활동 증명" icon="link" href="./cross-platform-proof-of-activity">
    외부 Web3 기여가 RocX 가치 체계에 들어오는 방식을 확인합니다.
  </Card>
  <Card title="활동 등록과 검증" icon="shield-check" href="./activity-registration-and-verification">
    출처, 작성자, 중복, 관련성, 유효성 및 어뷰징 검토를 확인합니다.
  </Card>
  <Card title="평가와 기여 점수" icon="scale-balanced" href="./community-evaluation-and-contribution-score">
...
<CardGroup cols={3}>
  <Card title="액티브 에너지" icon="zap" href="./active-energy">
    활동과 참여에 사용되는 비양도형 오프체인 생태계 자원입니다.
  </Card>
  <Card title="평판" icon="badge-check" href="./reputation-layer">
    장기적인 품질, 신뢰, 지속성 및 기여 이력을 나타내는 비양도형 기록입니다.
  </Card>
  <Card title="활동 정체성" icon="id-card" href="./activity-identity">
